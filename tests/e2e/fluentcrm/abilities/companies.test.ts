...
describe("FluentCRM Companies", () => {
  ...
  describe("Create Company", () => {
    ...
    it("should create company with full profile data", async () => {
      ...
      expect(result.data.company.description).toBe(
        "A comprehensive test company with all fields populated",
      );
    ...
    it("should create company with website URL", async () => {
      ...
      expect(result.success).toBe(true);
      expect(result.data.company.website).toBe(
  ...
  describe("List Companies", () => {
    ...
    it("should search companies by name", async () => {
      ...
      expect(result.success).toBe(true);
      expect(
        result.data.companies.some((c: any) => c.name === searchName),
      ).toBe(true);
    });
    ...
    it("should search companies by email", async () => {
      ...
      expect(result.success).toBe(true);
      expect(result.data.companies.some((c: any) => c.email === email)).toBe(
        true,
      );
    });
    ...
    it("should search companies by partial name", async () => {
      ...
      expect(result.success).toBe(true);
      expect(
        result.data.companies.some((c: any) => c.name.includes(uniquePrefix)),
      ).toBe(true);
    });
  ...
  describe("Update Company", () => {
    ...
    it("should update website", async () => {
      ...
      expect(result.success).toBe(true);
      expect(result.data.company.website).toBe(
        "https://updated-website.example.com",
      );
    });
  ...
  describe("Add Subscriber to Company", () => {
    ...
    beforeEach(async () => {
      ...
      const subscriberResult = await mcp.callTool(
  ...
  describe("Remove Subscriber from Company", () => {
    ...
    it("should handle subscriber not linked to company", async () => {
      const otherSubscriberResult = await mcp.callTool(
        "fluentcrm-create-subscriber",
        {
          email: generateTestEmail(),
        },
  ...
  describe("Get Company Subscribers", () => {
    ...
    it("should handle company with no subscribers", async () => {
      const emptyCompanyResult = await mcp.callTool(
