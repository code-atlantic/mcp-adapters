...
describe("FluentCRM Templates", () => {
  ...
  describe("Create Template", () => {
    ...
    it("should create template with all optional fields", async () => {
      ...
      const content =
        "<h1>{{contact.first_name}}</h1><p>Email body content</p>";
  ...
  describe("Update Template", () => {
    ...
    it("should update all fields at once", async () => {
      ...
      expect(result.data.template.email_pre_header).toBe(
        updates.email_pre_header,
      );
    });
  ...
  describe("Duplicate Template", () => {
    ...
    it("should copy email_pre_header meta field", async () => {
      ...
      expect(getResult.data.template.email_pre_header).toBe(
        "Original Pre-header",
      );
