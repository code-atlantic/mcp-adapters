...
class Labels extends BaseAbility {
    ...
    public function execute_list_labels(array $args): array {
        try {
            ...
            $labelModel = new \FluentBoards\App\Models\Label();
            $query = $labelModel->where('board_id', $board_id);
    ...
    public function execute_create_label(array $args): array {
        try {
            ...
            $labelModel = new \FluentBoards\App\Models\Label();
            $existing = $labelModel->where('board_id', $board_id)
                                  ->where('title', $title)
                                  ->first();
    ...
    public function execute_update_label(array $args): array {
        try {
            ...
            // Get the label
            $labelModel = new \FluentBoards\App\Models\Label();
            $label = $labelModel->where('id', $label_id)
            ...
            $label = $labelModel->find($label_id); // Refresh
    ...
    public function execute_delete_label(array $args): array {
        try {
            ...
            $relationModel->where('object_type', 'task')
    ...
    public function execute_add_label_to_task(array $args): array {
        try {
            ...
            $relationModel = new \FluentBoards\App\Models\Relation();
            $existing = $relationModel->where('object_type', 'task')
    ...
    public function execute_remove_label_from_task(array $args): array {
        try {
            ...
            $relationModel = new \FluentBoards\App\Models\Relation();
            $relation = $relationModel->where('object_type', 'task')
                                    ->where('object_id', $task_id)
                                    ->where('foreign_type', 'label')
                                    ->where('foreign_id', $label_id)
                                    ->first();
    ...
    public function execute_get_task_labels(array $args): array {
        try {
            ...
            $relationModel = new \FluentBoards\App\Models\Relation();
            $labelRelations = $relationModel->where('object_type', 'task')
                                          ->where('object_id', $task_id)
                                          ->where('foreign_type', 'label')
                                          ->get();
            ...
            foreach ($labelRelations as $relation) {
                $label = $labelModel->find($relation->foreign_id);
