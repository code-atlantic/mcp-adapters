...
class Attachments extends BaseAbility {
    ...
    public function execute_get_task_attachments(array $args): array {
        try {
            ...
            $attachmentModel = new \FluentBoards\App\Models\Attachment();
            $attachments = $attachmentModel->where('task_id', $task_id)
    ...
    public function execute_update_attachment(array $args): array {
        try {
            ...
            // Get the attachment
            $attachmentModel = new \FluentBoards\App\Models\Attachment();
            $attachment = $attachmentModel->where('id', $attachment_id)
            ...
            $attachment = $attachmentModel->find($attachment_id); // Refresh
    ...
    public function execute_get_attachment_files(array $args): array {
        try {
            ...
            $attachmentModel = new \FluentBoards\App\Models\Attachment();
            $files = $attachmentModel->where('task_id', $task_id)
                                   ->where('type', 'file')
