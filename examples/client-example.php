 ...
 */
add_filter(
	'mcp_client_permission',
	function ( $allowed, $client_id ) {
...
add_action(
	...
	function () {
		...
		foreach ( $statuses as $client_id => $status ) {
			// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log -- Example code for demonstration purposes.
			error_log(
				sprintf(
